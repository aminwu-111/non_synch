% This code is used to estimate parameters for the SLV model for the Greek
% cell phone share data using the MLPMCMC method
%the model is 
...
function lpos_p = l_posterior(Theta, lik)
    log_lik = lik;
    log_prior =  lG(Theta(1),-5,1)+lG(Theta(2),-5,1)+lG(Theta(3),-6,1)+lG(Theta(4),-5,1)+lG(Theta(5),-2,1)+lG(Theta(6),-2,1)+lG(Theta(7),-1,1);
